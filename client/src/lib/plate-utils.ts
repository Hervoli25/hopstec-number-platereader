...
// Get country hint placeholders
export function getPlateExamples(countryHint: string): string {
  switch (countryHint) {
    case "FR":
      return "e.g., AB-123-CD or 1234 AB 75";
    case "ZA":
      return "e.g., CA 123-456 or GP ABC 123";
    case "CD":
      return "e.g., 123 A KIN or KN 1234";
    default:
